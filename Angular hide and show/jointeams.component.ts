...
public thmul="*"
  ...
  output(){
    ...
    var out:any = this.input
    var adddd = out.indexOf("+")
    var subb = out.indexOf("-")
    var mull = out.indexOf("*")
    var divv = out.indexOf("%")
    // alert(subb)
...
if(0 <= adddd){
  ...
  addd= out.split("+")
    // alert(addd)
   var str1 = parseFloat(addd[0])
   var str2 =  parseFloat(addd[1])
...
if(0 <= divv){
  ...
  add(){
    this.input+=this.thadd
  }
  sub(){
    this.input+=this.thsub
  }
  mul(){
    this.input+=this.thmul
  }
  div(){
    this.input+=this.thdiv
  }
thi(){
  this.input+=this.th1
}
