...
@NgModule({
  declarations: [
    ...
    HeaderComponent,  DashbordComponent,  ChangepasswordComponent,
     ...
     LandingComponent, HomeComponent,CompeteonlineComponent,SettingsComponent,MypageComponent, 
     LivePerformanceComponent, JoinAnthyakshariComponent, InviteFriendsComponent, TopPlayersComponent,
      AdvertiseComponent, SpinCoinsComponent, 
      LiveCompitationComponent, PlayrandomlyComponent, TimerComponent,DpuploadComponent,
      Scratch
  ],
  imports: [
    BrowserModule,
    ...
    FormsModule, RouterModuleClass, ReactiveFormsModule,
     HttpClientModule,MaterialsModule,NgOtpInputModule
  ], 
